...
class Mealsburger extends StatefulWidget {
  const Mealsburger({super.key});

  @override
  State<Mealsburger> createState() => _MealsburgerState();
}

class _MealsburgerState extends State<Mealsburger> {
  String searchQuery = "";
